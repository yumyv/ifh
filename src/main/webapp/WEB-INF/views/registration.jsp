            ...
            <section class="greeting">
                <div class="greeting__container">
                    <div class="auth__container">
                        <form class="auth-form" action="<c:url value="/registration"/>" method="post">
                            <div class="row">
                                <label class="auth-form__label" for="name">User Name: </label>
                            </div>
                            <div class="row">
                                <input class="auth-form__input" type="text" name="name" id="name" pattern="^[a-zA-Z0-9]+$"/>
                            </div>
                            <div class="row">
                                <label class="auth-form__label" for="pass">Password: </label>
                            </div>
                            <div class="row">
                                <input class="auth-form__input" type="password" name="pass" id="pass" pattern="^[a-zA-Z0-9]+$"/>
                            </div>
                            ...
                            <div class="row">
                                <input class="auth-form__input auth-form__input--submit" type="submit" value="Registration"/>
                                <a class="auth-registration-btn" href="<c:url value="/login"/>">Login</a>
                            </div>
                        </form>
                    </div>
                </div>
